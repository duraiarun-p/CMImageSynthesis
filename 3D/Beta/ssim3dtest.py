...
# dataCT=tf.expand_dims(dataCT,axis=0)
# dataCB=tf.expand_dims(dataCB,axis=0)
# score=custom_loss_3_gamma3D(dataCT, dataCB)
score1=custom_loss_5_epsilon3D(dataCT, dataCB)
