...
from CycleGAN_Archs_lib import CycleGAN_Gamma, dataload, dataload_direct, perf_metrics
...
weightoutputpath=os.path.join(weightoutputpath1, 'gamma_predicted_volume')
...
cGAN=CycleGAN_Gamma(mypath,weightoutputpath,lastweightpath,epochs=40,save_epoch_frequency=2,batch_size=3,imgshape=(256,256,1),newshape=(256,256),batch_set_size=10,saveweightflag=True,breakflag=False)
