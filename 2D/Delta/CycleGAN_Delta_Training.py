...
weightoutputpath=os.path.join(weightoutputpath1,'Delta_Output')
...
# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,weightoutputpath,lastweightpath,epochs=500,save_epoch_frequency=25,batch_size=3,imgshape=(256,256,1),newshape=(256,256),batch_set_size=100,saveweightflag=True,breakflag=False)
# def run_tf(cGAN):
